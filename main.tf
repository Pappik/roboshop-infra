...
module "docdb" {
 ...
 allow_cidr = lookup(lookup(lookup(lookup(var.vpc, "main" , null),"private_subnets", null), "app", null),"subnet_ids", null)
...
module "alb" {
  ...
  vpc_id = lookup(lookup(module.vpc, each.value.vpc_name, null), "vpc_id", null)
  allow_cidr = each.value.internal ? lookup(lookup(lookup(lookup(var.vpc, "main" , null),"private_subnets", null), "web", null),"subnet_ids", null) : ["0.0.0.0/0"]
